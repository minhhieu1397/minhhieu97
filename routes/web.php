...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('/users/edit', 'UserController@edit_user')->name('users.edit');
	Route::put('/users/edit', 'UserController@update_user')->name('users.update');
	...
	Route::get('/user/{user}/edit', 'UserController@edit')->name('admin.users.edit');
	Route::put('/user/{user}/edit', 'UserController@update')->name('admin.users.update');
	Route::put('/user/{user}/resetpassword', 'UserController@admin_resetpassword')->name('admin.user.resetpassword');
	Route::get('logout', 'UserController@logout')->name('users.logout');
	Route::delete('/user/{user}', 'UserController@destroy')->name('users.destroy');
	Route::get('/user/view/{user}', 'TimesheetController@view_timesheet')->name('admin.timesheet.user');
